...
module "test_instances" {
  source = "./modules/test-instances"

  vpc_id = module.lab.vpc_id
  subnet_ids = {
    "eu-north-1a" = module.lab.tgw_subnets_ids_map["eu-north-1a"]
    "eu-north-1b" = module.lab.tgw_subnets_ids_map["eu-north-1b"]
    "eu-north-1c" = module.lab.tgw_subnets_ids_map["eu-north-1c"]
  }
}