locals {
  ...
  gateway_load_balancer_name = "${var.deployment_prefix}-gwlb-tf"
  target_group_name = "${var.deployment_prefix}-tg-tf"
  asg_name = "${var.deployment_prefix}-asg-tf"
  gateway_name = "${var.deployment_prefix}-gateway-tf"
